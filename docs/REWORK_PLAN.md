# Weather Sandbox Rework Plan (v2)
...
### Goals
- Replace current strike-selection and channel rendering with a physically-inspired charge-network model.
- Improve cloud-to-ground (CG), intra-cloud (IC), branching coherence, and temporal flicker realism.

### Work Items
1. **Charge Field Layer**
...
2. **M1 Core Simulation/Lightning/Precip foundation** (Sections 1 + 9)
3. **M2 Rendering and Graphics stack** (Sections 4 + 8 + 7)
